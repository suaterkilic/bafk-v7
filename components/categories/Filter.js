...
const Filter = () => {
  return (
    <Fragment>
      <header className="app_theme-archive-header">
        {/* begin app_theme-archive-header-inside */}
        <div className="app_theme-archive-header-inside">
          <div className="product-found">
            <div>
              We've got <span>4</span> products for you
            </div>
          </div>
          <div className="app_theme-archive-header-tools">
            <form className="app_theme-ordering" method="get">
        ...
        {/* end app_theme-archive-header-inside */}
          ...
          <div className="site-shop-filters-inside">
            <aside className="widget-area">
              <div className="grid-x small-up-1 medium-up-3 large-up-4 shop-filters-area-content">
                <div className="cell">
                  <aside
                    id="app_theme_price_filter-2"
                    className="widget app_theme widget_price_filter"
                  >
                ...
                <div className="cell">
                  <aside
                    id="bafk_attributes_filter-3"
                    className="widget app_theme bafk_attributes_filter widget_layered_nav"
                  >
        ...
        <div className="bafk-active-filters"></div>
      </header>
    </Fragment>
  );
};
